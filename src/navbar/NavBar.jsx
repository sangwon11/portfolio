...
const NavBar = () => {
  return (
    ...
    <div className='w-screen bg-[#fff] z-10 h-[100px] fixed flex sm:flex-row flex-col justify-between items-center border-solid border-b-2'>
      <Link to="about-me" smooth={true} duration={200} className='cursor-pointer z-10 text-[40px] font-bold sm:pl-[30px] pl-[0]'>PORTFOLIO</Link>
      <div className='flex sm:justify-between justify-around sm:w-[300px] w-[200px] sm:text-[30px] text-[15px] font-bold sm:pr-[30px] pr-[0]'>
